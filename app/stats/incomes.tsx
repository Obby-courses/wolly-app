...
export default function IncomesScreen() {
  ...
  useEffect(() => {
    analytics.trackClick(ANALYTICS_BUTTONS.TIME_FILTER_SELECT, ANALYTICS_SCREENS.STATS_INCOMES, { range: timeRange });
  }, [timeRange]);
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} scrollEnabled={true}>
          {loading && transactions.length === 0 ? (
            ...
            <View style={loading && { opacity: 0.6 }}>
              {/* Entrata Totale del Periodo */}
              <View style={styles.totalPeriodCard}>
                <Text style={styles.totalPeriodLabel}>Entrata totale del periodo</Text>
