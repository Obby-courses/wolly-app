              ...
              {dateMode === 'single' ? (
                ...
                <View style={styles.periodicForm}>
                  ...
                  <PeriodicDateSelector
                    frequency={periodicFrequency}
                    recurrenceDay={periodicDay}
                    startDate={editableExpense.date}
                    onChange={(day, date) => {
                      setPeriodicDay(day);
                      if (date && date !== editableExpense.date) {
                        updateField('date', date);
                      }
                    }}
                    labelStyle={[styles.periodicLabel, { marginTop: 14 }]}
                    inputStyle={styles.periodicInput}
                  />
                  {!periodicName.trim() && (
